...
<body class="font-sans antialiased" onload="loadReportData()">
    ...
    <script>
        ...
        function loadReportData() {
            ...
            let medtech_signature_src = `${window.location.origin}/storage/${report.medtech_signature}`
            document.getElementById('printContent').innerHTML = `
                <!-- Header -->
                <div class="pb-6 mb-8">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-4">
                        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                            ...
                            <div class="p-5"><p style="white-space: break-spaces;" class="text-sm text-gray-900 leading-relaxed">${report.identification_verification || 'N/A'}</p></div>
                        </div>
                        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                            <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-5 py-3 border-b border-gray-200">
                                <h3 class="text-sm font-bold text-gray-700 uppercase">Root Cause / Findings</h3>
                            </div>
                            <div class="p-5"><p style="white-space: break-spaces;" class="text-sm text-gray-900 leading-relaxed">${report.root_cause_findings || 'N/A'}</p></div>
                        </div>
                        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                            <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-5 py-3 border-b border-gray-200">
                                <h3 class="text-sm font-bold text-gray-700 uppercase">Action Taken</h3>
                            </div>
                            <div class="p-5"><p style="white-space: break-spaces;" class="text-sm text-gray-900 leading-relaxed">${report.action_taken || 'N/A'}</p></div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                            ...
                            <div class="p-5"><p style="white-space: break-spaces;" class="text-sm text-gray-900 leading-relaxed">${report.recommendations}</p></div>
                        </div>` : ''}
                    </div>
                </div>
                        ...
                        <div class="text-center">
                            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200 shadow-lg">
                                ...
                                <div class="h-32 flex items-end justify-center mb-6 bg-white/50 rounded-lg p-4">
                                    <div class="text-gray-400"><img style="height: 100px !important;" src="${medtech_signature_src}"/></div>
                                </div>
