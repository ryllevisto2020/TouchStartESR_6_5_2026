    ...
    <script>
        ...
        function renderTable() {
            ...
            tbody.innerHTML = paginated.map(record => {
                ...
                const issue_root_cause = (record.root_cause_findings) ? record.root_cause_findings.substring(0, 70): "N/A";
                const action = (record.action_taken) ? record.action_taken.substring(0, 60) : "N/A";
                return `
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-6 py-4 max-w-xs">
                            <div class="text-xs text-slate-600"><span class="font-semibold">Issue:</span> ${issue_root_cause} </div>
                            <div class="text-xs text-slate-600 mt-1"><span class="font-semibold">Action:</span> ${action}</div>
                            ${partsBadge}
                        </td>
                        <td class="px-6 py-4">
        ...
        window.viewDetails = (id) => {
            ...
            let service_images_path = '';
            let calibration_images_path = '';
