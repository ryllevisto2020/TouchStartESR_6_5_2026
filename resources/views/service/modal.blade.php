...
<div id="service-modal" class="fixed z-50 inset-0 hidden" style="overflow:hidden;">
    ...
    <div class="absolute inset-0 overflow-y-auto flex items-end sm:items-center justify-center sm:p-4">
        ...
        <div id="modal-container" class="relative w-full bg-white text-left shadow-2xl"
            ...
            <!-- Form -->
            <form id="service-form" enctype="multipart/form-data" style="flex:1;display:flex;flex-direction:column;">
                @csrf
                ...
                <div class="px-4 pt-5 pb-4 sm:px-6" style="flex:1;">
                    ...
                    <div class="svc-grid">
                        ...
                        <div style="display:flex;flex-direction:column;gap:1.25rem;">
                            ...
                            <div>
                                ...
                                <div class="svc-checkbox-grid">
                                    <label class="svc-check-card">
                                        <input type="checkbox" id="service_type[]" name="service_type[]" value="PMS" class="services rounded text-blue-600 focus:ring-blue-500">
                                        <span class="ml-2.5 text-sm font-medium">PMS</span>
                                    </label>
                                    <label class="svc-check-card">
                                        <input type="checkbox" id="service_type[]" name="service_type[]" value="Troubleshooting" class="services rounded text-blue-600 focus:ring-blue-500">
                                        <span class="ml-2.5 text-sm font-medium">Troubleshooting</span>
                                    </label>
                                    <label class="svc-check-card">
                                        <input type="checkbox" id="service_type[]" name="service_type[]" value="Installation" class="services rounded text-blue-600 focus:ring-blue-500">
                                        <span class="ml-2.5 text-sm font-medium">Installation</span>
                                    </label>
                                    <label class="svc-check-card">
                                        <input type="checkbox" id="service_type[]" name="service_type[]" value="Warranty" class="services rounded text-blue-600 focus:ring-blue-500">
                                        <span class="ml-2.5 text-sm font-medium">Warranty</span>
                                    </label>
                                    <label class="svc-check-card">
                                        <input type="checkbox" id="service_type[]" name="service_type[]" value="Calibration" class="services rounded text-blue-600 focus:ring-blue-500">
                                ...
                                <div id="others-input" class="mt-2.5 hidden">
                                    <input type="text" id="service_type[]" name="service_type[]" placeholder="Please specify..."
                            ...
                            <div>
                                ...
                                <textarea id="identification" name="identification" rows="3" class="svc-textarea"
                            ...
                            <div>
                                ...
                                <textarea id="root_cause" name="root_cause" rows="3" class="svc-textarea"
                            ...
                            <div>
                                ...
                                <textarea id="action_taken" name="action_taken" rows="3" class="svc-textarea"
                        ...
                        <div style="display:flex;flex-direction:column;gap:1.25rem;">
                            ...
                            <div>
                                ...
                                <div class="svc-radio-row">
                                    <label class="svc-check-card" style="flex:1;">
                                        <input type="radio" id="equipment_status" name="equipment_status" value="Operational"
                                               class="text-blue-600 focus:ring-blue-500" required>
                                        <span class="ml-2.5 text-sm font-medium">Operational</span>
                                    </label>
                                    <label class="svc-check-card" style="flex:1;">
                                        <input type="radio" id="equipment_status" name="equipment_status" value="Not Operational"
                                               class="text-blue-600 focus:ring-blue-500" required>
                            ...
                            <div>
                                ...
                                <textarea id="recommendations" name="recommendations" rows="3" class="svc-textarea"
                            ...
                            <div>
                                ...
                                <div id="parts-container" style="display:flex;flex-direction:column;gap:0.75rem;">
                                    ...
                                    <div class="parts-row">
                                        <input type="number" id="qty" name="qty[]" placeholder="Qty" class="svc-input parts-qty">
                                        <input type="text" id="particulars" name="particulars[]" placeholder="Particulars" class="svc-input parts-part">
                                        <input type="text" id="si_dr_no" name="si_dr_no[]" placeholder="S.I./D.R. No." class="svc-input parts-si">
                                    </div>
                                    </fieldset>
                                </div>
                    ...
                    <div class="mt-5 svc-personnel-grid">
                        <div>
                            ...
                            <input type="text" id="approved_by" name="approved_by" placeholder="Enter name of MedTech approver"
                        ...
                        <div>
                            ...
                            <input type="hidden" id="service_engineer" name="service_engineer" value="{{$employee_details->emp_first_name}} {{$employee_details->emp_last_name}}">
                            <input type="hidden" id="service_engineer_department" name="service_engineer_department" value="{{$employee_details->emp_deparment}}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="svc-footer-btns">
                        ...
                        <div class="svc-footer-right">
                            ...
                            <button type="submit" id="submit-service-btn" class="submit-service svc-btn-submit">
                                <i class="change-format fas fa-check-circle mr-1.5"></i>Complete Service
                            </button>
                        </div>
                    </div>
                </div>
...
$(document).ready(function () {
    ...
    $("#service-form").submit(function(e){
        ...
        if(isSubmit){
            isSubmit = false;
            $(".change-format").removeClass('fas fa-check-circle mr-1.5').addClass('fa fa-spinner fa-spin');
            try {
    ...
    $("#save-draft-btn").click(function(e){
        ...
        if(signature.isEmpty() || !signature.isEmpty()){
            ...
            if(signature.isEmpty()){
                ...
                signature_medtech = medtech_signature.val();
            }
    ...
    function submitDraftReport(serviceID,e){
        ...
        if(!signature.isEmpty() || medtech_signature.val() != ""){
            ...
            let qty = Array();
            let particulars = Array();
            let si_dr_no = Array();
            let form = new FormData();

            $('input[type="checkbox"]:checked').each(function(){
                if($(this).val() === 'on'){
                    let others = $(".services-others-write").val();
                    service_type.push(others);
                }else{
            ...
            $("[id='particulars']").each(function(e){
                particulars.push($(this).val())
            })

            $("[id='si_dr_no']").each(function(e){
